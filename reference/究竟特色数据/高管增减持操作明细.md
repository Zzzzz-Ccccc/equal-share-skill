...
| 名称 | 类型 | 必填 | 默认值 | 说明 |
|:---|:---|:---|:---|:---|
| `interfaceId` | `str` | 是 | "DRAGON_TIGER_MANAGER_HOLDING_STOCKCODE_OPT_DETAIL_D294B48C" | 接口ID |
...
data = api.query_kjj_data(
    interfaceId="DRAGON_TIGER_MANAGER_HOLDING_STOCKCODE_OPT_DETAIL_D294B48C",
