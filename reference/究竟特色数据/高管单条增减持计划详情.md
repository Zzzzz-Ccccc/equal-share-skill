...
| 名称 | 类型 | 必填 | 默认值 | 说明 |
|:---|:---|:---|:---|:---|
| `interfaceId` | `str` | 是 | "DRAGON_TIGER_MANAGER_HOLDING_STOCKCODE_PLAN_DETAIL_B5554323" | 接口ID |
...
data = api.query_kjj_data(
    interfaceId="DRAGON_TIGER_MANAGER_HOLDING_STOCKCODE_PLAN_DETAIL_B5554323",
